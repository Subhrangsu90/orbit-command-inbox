      ...
      <div className="max-w-3xl space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-sm text-on-surface-variant">
            Orchestrate and automate your email workflows with intelligent command routing.
          </p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="overflow-hidden rounded-2xl border border-primary/20 bg-gradient-to-br from-surface-container-lowest to-primary/5 shadow-sm">
            <div className="p-8 md:p-12 flex flex-col md:flex-row items-center md:items-start gap-6">
              ...
              <div className="flex-1 text-center md:text-left space-y-2">
                <div className="flex flex-col md:flex-row md:items-center gap-2">
                  <h3 className="text-lg font-bold text-on-surface">Gmail Account Connected</h3>
                ...
                <p className="text-xs text-on-surface-variant max-w-md">
                  Your inbox is linked. The system is actively monitoring incoming messages to execute authorized commands.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="p-12 border border-dashed border-outline-variant bg-surface-container-lowest rounded-2xl flex flex-col items-center justify-center text-center">
            <div className="relative mb-4">
              <Mail className="size-12 text-on-surface-variant opacity-60" />
            ...
            <p className="font-semibold text-sm text-on-surface">Gmail disconnected</p>
            <p className="text-xs text-on-surface-variant mt-1 max-w-sm">
              Please go to settings page to connect your Gmail account and start orchestrating emails.
            </p>
            <Link
              href="/settings"
